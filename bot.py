...
async def handle_action(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "Купить билет":
        ...
        rules = (
            ...
            "3️⃣ Мы имеем право отказать в посещении мероприятия без объяснения причин и без возврата билета.\n"
            "4️⃣ Запрещён вход в грязной, рваной, спортивной одежде.\n"
            "5️⃣ Организаторы не несут ответственности за потерю личных вещей.\n"
            "6️⃣ На мероприятии запрещены: агрессия, наркотики, оружие.\n"
            "7️⃣ Администрация вправе удалять нарушителей без компенсации.\n\n"
